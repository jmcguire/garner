...
rife; **ripe**. While a tree may be *rife* \(= abundant\) with fruit, and that fruit may be *ripe* \(= fully mature\), the terms are unrelated. To confuse them is a surprisingly common malapropism—e.g.:
