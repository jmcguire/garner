...
realtor; **real-estate agent**; **estate agent**. *Realtor* (= a real-estate agent or broker) has two syllables, not three: /**reel**-tәr/, not /**reel**-ә-tәr/. (See pronunciation (b).) This Americanism is a morphological deformity, since the *-or* suffix in Latin is appended only to verb elements, and *realt-* is not a verb element. But the term is too well established in AmE to quibble with its makeup. Its shortness commends it.
...
**Language-Change Index:** *realtor* mispronounced with three syllables: Stage 2
