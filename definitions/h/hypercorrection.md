...
literary critic of the *New York Herald Tribune*. He placed the hypercorrect
*I* in about the same class as the "hauteur in such expressions as ‘Whom are
you anyways?' " Here's what he wrote:

I have been planning a piece on personal pronouns and the death of the
accusative. Nobody says ‘I gave it to they,' but ‘me' [in a coordinate pair]
is almost dead, and I have heard its dying screams from Bermuda to Columbus:
‘He gave it to Janey and I.' (We have to thank Hart, Rodgers, and O'Hara for
the lovely attack on this.) My cousin Earl Fisher said to me in Columbus,
‘Louis and I gave it to he and she last Christmas.' " (Letter of James
Thurber to Lewis Gannett, 25 June 1956, in *Selected Letters of James
Thurber* 173 [Helen Thurber & Edward Weeks eds., 1980].)

To chart the slow death as it continues in the 21st century, I posed a
Twitter poll in April 2021, asking my followers about a phrase used that
month by Jimmy Fallon, the television personality: "It is time for Joe and
*I* [read *me*] to play." With 1,161 respondents, here are the votes: (1)
outright barbarism (66%); (2) fully acceptable (12%); (3) who cares? (12%);
(4) a hip substitute for *me* (10%). Despite that lopsided vote, the usage
is probably at Stage 3 on the Language-Change Index. More and more speakers
of English mistakenly group *Joe and I* into an immutable unit that carries
an air of hauteur or hipness: they think it can be placed in various
contexts without modification. And that's the essence of hypercorrection.

The probable cause? One respondent in the Twitter poll attributed it to "all
those parents who yelled at kids when they said, ‘Jimmy and me are going
down to the park.' " The kids ended up saying to themselves, "Don't use
*me*? Okay, then I'll never use *me*!" That's doubtless true: it probably
wasn't an insistence on *It is I* (see **it is I**), but rather repeated
admonitions about *Me and my friends are going to . . .* or *My friends and
me are going to . . . .* The corrections of these nonstandard phrasings put
some people on tenterhooks, and through hasty generalization they came to
fear that something is amiss with the word *me*. Safer, they think, to stick
to *I*. In earlier editions of this book, these misusages were called "gross
linguistic gaffes," with the comment that "it's perennially surprising how
many otherwise educated speakers commit them." Given the Stage 3 level I'm
now giving these mistakes, it's probably necessary to delete the word
*gross*. They're just gaffes—and at some point that word will probably be
downgraded to *minor blemishes* and ultimately (a century from now?) to
*acceptable variants*.

Some people already want to classify the errors as acceptable variants. They
say the issue is all about coordination: the error invariably appears after
a conjunction (usually *and*, but sometimes *or*). That is, many speakers
seem to believe that the nominative *I* is better after the word *and*. The
traditional view is that they're entirely wrong to think this: in the
coordinated pair, both the pronoun and the noun element with which it is
conjoined are either subjects or objects. Hence you should say and write
*They gave it to Caroline and me* for the same reason that you should say
*They gave it to me*.

And again, the error occurs most often when the pronoun follows a
conjunction. Consider the many instances of *to him and I* and *for her and
I*. These kinds of phrasings inexplicably skyrocketed in frequency at the
beginning of the 21st century.

Consider the following carpet-bombing of examples from television
presenters—all of whom seem to perceive the superiority of the nominative
...
second object is involved, some people want to make the nominative case
invariable. For now, it's an error. In 1980, it might have been classed a
Stage 1 misusage. By 2020, it had moved to Stage 3. If it gets to Stage 4,
then the next stage—full acceptability—seems all but assured. But despite
the number of examples just cited, it's not even a close contender in print
sources. It could be that we'll end up, for a time, with something quasi-
acceptable in speech that is highly stigmatized in print. That's not
...
things can get moderately tricky—e.g.: "In ‘An Independent Woman,' Barbara
is confronted by an African-American burglar, *whom* [read *who*] she
realizes is well-educated but desperate." Jocelyn McClurg, "At 82, Fast Has
Slowed but Hasn't Stopped as a Writer," *Fresno Bee*, 3 Aug. 1997, at G2.
...
introduce them, and the result is often a miscue or ambiguity—e.g.: "Each is
*trying subtly to exert* his or her influence over the other." Mark H.
McCormack, *What They Don't Teach You at Harvard Business School* 26 (1984).
In that sentence, does *subtly* modify the participle *trying* or the
infinitive *to exert*? Because we cannot tell, the sentence needs to be
revised in any of the following ways: (1) *Each is subtly trying to exert
his or her influence over the other*, (2) *Each is trying to exert his or
her influence subtly over the other*, (3) *Each is trying to subtly exert
...
phrase. (See adverbs (b).) The canard to the contrary frequently causes
...
use
the latter pronunciation sounds foolish. Another French word that gives some
AmE speakers trouble is *concierge*: it should be pronounced /kon-see-
**erzh**/, not /kon-see-**er**/. See **concierge**.

Similarly, American and British printers refer to the typefaces without
"feet" (small projections coming off the straight lines) as *sans serif*
/sanz **ser**-if/, not /sahnz sә-**reef**/. The latter pronunciation may
show
a supposed familiarity with the French language (though *serif* is Dutch),
but it betrays an unfamiliarity both with publishing and with the English
language.

Even native-English words can cause problems. The word *often*, for example,
preferably has a silent *t*, yet some speakers (unnaturally) pronounce it
because of the spelling. The next logical step would be to pronounce
*administration* /ad-min-i-**stray**-tee-on/, and all other words with the *-
tion*
suffix similarly. See pronunciation (a) & **often (a)**.
