...
hyphenation; **hyphenization**. *Hyphenation* is the standard form for the use of hyphens to separate words into syllables—e.g.: "Since the demise of typewriters and the universal use of computers in the newsroom, *hyphenization* \[read *hyphenation*\] is done automatically by the computer." Jean Otto, " ‘Van' or ‘Von'?," *Rocky Mountain News* \(Denver\), 1 Jan. 1995, at A106.
...
By the 2020s, complaints about "hyphenated Americans" had led to the near-wholesale abandonment of the hyphens in phrases such as *African American* and *Mexican American*—as if the punctuation mark had been the source of the lamented social ill. In the run-up to that change, one writer asserted: "Logically, the ‘*hyphenization*' of the nation means one thing: We'll always be a splintered people." Letter of Linda Smith, "Lose the Hyphens—Please," *Orlando Sentinel*, 9 May 2016, at A9. For a full discussion of "hyphenated Americans" and the modern trend to drop hyphens, see race-related terms \(d\).

For more on hyphens—"the pests of punctuation"—see punctuation \(j\).
