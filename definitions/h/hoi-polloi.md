...
hoi polloi \(= the common people, the masses\). Because *hoi* in Greek means "the \(plural\)," *the hoi polloi* is technically redundant. But the three-word phrase has spread since about 1850, has become common, and ought to be accepted. In fact, the definite article \(*the*\) is by far the most common word preceding *hoi polloi* in print sources—and has been since the mid-1800s.
...
2. *hoi polloi* in the sense "elite": Stage 1
