...
*Hopefully* expresses optimism—having a heart full of hope—just as much in the new use as in the uncontroversial older sense \(*It is better to travel hopefully than to arrive*\). But in sentences like *Hopefully, things will improve*, the optimism is associated with the speaker's attitude to the content of what is said. The Yale lexicographical scholar Fred R. Shapiro reports a possibly relevant example of this sort of use from as early as 1703 \(see Shapiro, "Earlier Computer-Assisted Evidence on the Emergence of *Hopefully* as a Sentence Adverb," 75 *Am. Speech* 439 \[1999\]\), but most attested cases date from 1930 or later. After 1960, attentive readers noticed a distinct increase in the frequency of the sentence-adverb use, and around 1965 the perceived novelty in AmE began to stimulate criticism. Wilson Follett's *Modern American Usage* \(1966\) expressed pointed criticism, echoed vociferously by E.B. White in editions of *The Elements of Style* that appeared after 1972 \(see, e.g., the 4th edition \[2000\], at 48\).
...
Clause-modifying *hopefully* remains a skunked term. You might well decide to avoid it in all senses if you're concerned with your credibility: if you use it, a few readers may tut-tut you. Yet many experts would like the new use of *hopefully* declared Stage 5 on the Language-Change Index—utterly irreproachable. To test the idea, I put out a Twitter poll in October 2020, asking people whether *hopefully* in its common uses \(a\) is wholly unobjectionable, or \(b\) retains a bad odor. With 823 votes tallied, some 42% answered \(b\). I had predicted that the number would be less than 5%. So resistance to the word remains more durable than one might think.
