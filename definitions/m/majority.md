...
The terms *majority* and *plurality* are usually distinguished, so that the results of an election are announced as one or the other depending on whether one candidate or question won more than 50% of the vote. In this commonly observed distinction, a *plurality* is less than a *majority*. That can make a difference in the outcome (see the example in the paragraph above) or in the strength of the winner's mandate. For example, a *plurality* opinion by the Supreme Court (i.e., one that is signed by fewer than five justices) may carry less weight as precedent than a *majority* opinion. But if rules merely call for a *plurality* election, the distinction disappears: a *majority* is always a *plurality* as well.
