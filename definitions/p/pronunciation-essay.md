...
But when it comes to words that are seldom pronounced by English-speaking people—as with any learned word—the advice to conform with our neighbors' pronunciation becomes problematic. For here we find diversity, not uniformity—the result of the infrequent occasions when the words are pronounced. And when opinions diverge among reasonable and educated people, there must be considerable leeway.
...
But some common words do acquire nontraditional pronunciations. A prime example is *often*, which traditionally \(and most properly\) has a silent *t*: /**off**-n/. Because we see it frequently \(ahem\) in print, some people, over time, seem to have intuited that the *t* is there to be pronounced. So the nontraditional pronunciation spreads. See **often \(a\)** & hypercorrection \(k\). See also **beldame**, **petit jury**, **porpoise**, **template** & **tortoise**.

There are many words with traditionally silent consonants, some better known than others: *almond* /**ahm**-әnd/, *answer* /**an\[t\]**-sәr/, *boatswain* /**boh**-sәn/, *chthonic* /**thon**-ik/, *climb* /klīm/, *colonel* /**kәr**-nәl/, *comb* /kohm/, *ctenoid* /**ten**-oyd/, *depot* /**dee**-poh/, *gnaw* /naw/, *gnostic* /**nos**-tik/, *gunwale* /**gәn**-әl/, *impugn* /im-**pyoon**/, *indict* /in-**dīt**/, *island* /**ī**-lәnd/, *knack* /nak/, *knife* /nīf/, *knot* /not/, *listen* /**lis**-n/, *mnemonic* /nә-**mon**-ik/, *phlegm* /flem/, *pneumatic* /noo-**mat**-ik/, *psoriasis* /sә-**rī**-ә-sis/, *ptomaine* /**toh**-mayn/, *puisne* /**pyoo**-nee/, *rendezvous* /**ron**-day-voo/, *subtle* /**sәt**-l/, etc.
