...
Modern grammarians can't quite agree on what is happening with coordinated personal pronouns. One book blames rules-based learning: "The influence of prescriptive grammar may . . . lead to an occasional hypercorrect use of nominative forms in contexts where the accusative form is the regular choice." Douglas Biber et al., *Longman Grammar of Spoken and Written English* 338 \(1999\). That's a surprising assertion, given that prescriptive grammarians have been sticklers for conventional pronoun use in all contexts. The authors go on to quote conversational examples using nonstandard phrasing <not enough for you and I> <that'll be nice for you and I> <natural traitors like you and I>. They then add: "As the coordinated noun phrases in these examples are the complement of a preposition, we expect accusative forms." \(*Ibid.* at 338–39.\) But then they assert, overoptimistically, that "such examples of hypercorrect nominative forms are generally rare." \(*Ibid.* at 339.\)

Another leading grammar, *CGEL*, notes that "there can be little doubt that the quite common" hypercorrection is related to the stigma attached to "accusatives in subject coordination" <me and Larry are going to the movie>. \(P. 463.\) People "generalize their avoidance of such coordinate accusatives to other functional positions." \(*Ibid.*\) *CGEL* makes the interesting observation that the main problem is with *I*. Nobody says \**They've invited the Smiths and we to lunch*. But people often do say \**They've invited Sarah and I to lunch*, where *me* would be the standard pronoun. The esteemed authors of *CGEL* then make a sweeping statement—that constructions "with *I* as the final coordinate \[as an object\] are so common in speech and used by so broad a range of speakers that it has to be recognized as a variety of Standard English." \(*Ibid*.\) That is a step too far: perhaps it's at Stage 2 on the Language-Change Index, but certainly not Stage 5.
...
But often, as in the following sentences, the sense undoubtedly carries the idea of plurality from an antecedent pronoun to a referent one: "Since *everyone* there was Japanese, and none of *them* had ever traveled abroad, *they* needed a translator." / "*Everybody* was crouched behind furniture to surprise me, and *they* tried to. But I already knew *they* were there." Try changing *them* to *him* and *they* to *he*, and you end up with deranged writing. synesis dictates that the logical sense vanquishes the strict rules of grammar with these words in transition.
