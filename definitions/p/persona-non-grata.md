...
persona non grata (/pәr-**soh**-nә non **grah**-tә/) \[L. "an unwanted person"\] is so spelled. In law the phrase most commonly refers to a diplomat who is not acceptable to a host country, but today the phrase refers informally to anyone who is unwelcome. E.g.: "Whitney was believed to be damaged goods and was marked as *persona non grata* at the end of his three-plus years with the Florida Panthers." Michael Arace, "All-Star Billing," *Columbus Dispatch*, 17 Jan. 2003, at D1.
...
The Latin plural is *personae non gratae* (/pәr-**soh**-nee non **gray**-tee/, not /pәr-**soh**-nī/ or /-nay/), which can't be readily anglicized: *\*personas non grata* doesn't work, and neither does *\*persona non gratas* (or, worse yet, *\*personas non gratas*). In the first two quotations above, a plural is called for: the writers might better have used *unwelcome*, *unacceptable*, *ostracized*, or some other word—or else to redo their childhood learning Latin. What seems to be happening today is that *persona non grata* is becoming freely singular or plural, as the sense requires.
