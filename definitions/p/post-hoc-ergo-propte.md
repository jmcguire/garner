...
Two common usages, *since* for *because* \(acceptable\) and *consequent* for *subsequent* \(unacceptable\), exemplify the fallacy: they originated when speakers and writers confused causality with temporality. See **post hoc**.
