...
grammaticaster (= an inferior grammarian)

medicaster (= a quack; a medical charlatan)

philologaster (= an incompetent philologist)

poetaster (= a poet who writes trash)

politicaster (= a contemptible politician)
...
calculus (= lit., a small pebble on an abacus)

canalicule; canaliculus (= a small duct or canal)

capsule (= a small cylindrical container)

corpuscule (= a minute particle of matter)

flocculus (= a small egg-shaped lobe of the cerebellum)

globule (= a small round particle; a droplet)

granule (= a small grain; a pellet)

homunculus (= a small person or humanoid being)

molecule (= the smallest fundamental unit for a chemical reaction)

nodule (= a small swelling in the body)
...
chapel (= a small building for religious worship)

hovel (= a wretched dwelling)

pimpernel (= a small flower of the primrose family)

roundel (= a small disk)
...
boccarella (= a small opening to either side of a glass furnace's main opening)

brocatelle (= imitation brocade)

camerelle (= a small chamber)

chlorella (= a single-celled alga)
...
baronet (= the lowest hereditary English title, denoting a gentleman commoner rather than a nobleman)

cellaret (= a cabinet for storing wines)

cigarette (= a slim, short, tobacco-filled cylinder, smaller than a cigar)

kitchenette (= a very small kitchen)

nymphet (= a sexually mature girl, esp. one near the age of consent)

pantalettes or *\**pantalets (= 19th-century ruffled leg coverings used by women and children)

pipette (= a slender pipe used by chemists to measure small quantities of liquid)
...
Charlie; Charley (= Charles; Charlene)

doggy; doggie (= a puppy or small dog)

Jeanie (= Jean, Jeanette, etc.)

kitty (= a young cat)

Kitty (= Catharine, Kathryn, etc.)

mousie; mousy (= a mouse, esp. a young or very small one)

pussy (= a cat)

Sally; Sallie (= Sarah)

sonny (= a boy or a young man, esp. one of inferior standing)

Willie; Willy (= William)
...
riding (= an administrative or political subdivision)
...
cannikin (= lit., a small can; a canister)

catkin (= derived fr. the Dutch for "kitten": *katteken*)

lambkin (= lit., a small or young lamb; used affectionately of young children)
...
leaflet (= an informative writing on a single piece of paper)

murrelet (= a small North Pacific auk)

piglet (= a baby pig)

rivulet (= a very small stream)

roundlet (= a small circle or circular thing)
...
fosterling (= a foster or adopted child, esp. one treated as inferior to other children)

foundling (= an abandoned infant who is taken in and cared for, esp. out of charity)

gosling (= a baby goose)

lordling (= a petty, insignificant lord)
...
paddock (= a small pasture or enclosure for animals)

tussock (= a small bunch or tuft, as of grass or hair)
