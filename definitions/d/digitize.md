...
digitize; **digitalize**. *Digitize* has led two lives. In its first, it meant "to point at" or "to manipulate with the fingers." That sense is rare today, but the computer age has found a new use for the word: "to convert into a binary string of data." The connection with the root word *digit* is that the binary on and off signals are represented by zeros and ones in the resulting code.

*Digitalize*, a medical term dating from the early 1800s, means "to give digitalis to," referring to the drug derived from the digitalis plant and used in treating heart conditions. Since the reincarnation of *digitize*, however, *digitalize* has been invading its territory as a variant—e.g.:
