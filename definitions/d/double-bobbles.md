...
A similar error occurs when *compromise* is confused with *comprise*, which itself is often misused for *compose* or *constitute*. In strict usage, the parts compose the whole; the whole comprises the parts; the whole is composed of the parts; the parts are comprised in the whole. Hence the traditional view is that *\*is comprised of* is always wrong and should be replaced by *is composed of*, *is made up of*, or *comprises*. See **comprise \(a\), \(b\)**.
