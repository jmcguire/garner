...
event. The AmE phrase is usually *in the event that* \[\+ clause\]—an equivalent of *if* \<in the event that they fail\>. The British often write *in the event of* \[\+ noun phrase\] (usually a zombie noun)—as Americans sometimes do \<in the event of failure\>. Prefer *if* when it works.
