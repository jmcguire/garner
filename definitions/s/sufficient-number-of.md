...
\*sufficient number of, a. Although this phrase is certainly old, dating back to the 1600s, it is also certainly verbose for *enough*—e.g.:
 ...
 - "But the 1996 farm law requires the department to transfer sales to the private sector if *a sufficient number of* \[read *enough*\] agents were available in each state." "Farm Law Passed in 1996 Required Change," *Chicago Trib.*, 25 May 1997, at 2. (Note also the tense error: *were* \[five words from the end\] should be *are* to match the present-tense *requires*.)
