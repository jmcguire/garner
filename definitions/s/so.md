...
Why not just combine the two sentences into one? The answer is that doing so often spoils sentence length. You lose the greater emphasis of two sentence ends. So that's not typically a good option.

Of course, in standard english the sentence-starting *so* should follow from what has been said before. It should introduce a conclusion. If it's a message-starting *so*—for example, the first word of an email or text message—it's nothing but a speech tic reduced to writing. And it's a tic that will annoy readers who are traditionalists, especially those born before 1980 or so. The message-starting *so* is a bit of trendy, youthful slang—even among youthful academics.

In November 2017, an outbreak of protests about *so*-as-filler-and-not-as-illative took place at the BBC. Guests and panelists had used a thought-starting *so* frequently enough in BrE that audiences rebelled. Some suggested that those who used it did so as a temporizer similar to *uh*, *um*, or *erm* \[BrE\], while trying to think of what to say next. BBC presenter John Humphrys commented to the London *Times*: "The misplaced ‘so' has invaded everyday speech like some noxious weed in an untended garden" (15 Nov. 2017).
