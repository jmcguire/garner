...
identical takes either *with* or *to*. Historically, *with* has been considered better because one has *identity with* something or someone, not *to* it. *Identical to* was not widely used until the mid-20th century. The *OED*'s illustrative examples long contained only the phrase *identical with*. But since the mid-1970s in AmE and the mid-1980s in BrE, *identical to* has been the predominant form in print sources. E.g.: "The standard adopted for the regulation of a manufacturer's health claims must be nearly *identical to* those employed to test the constitutionality of the hypothetical regulation." Martin H. Redish, *Commercial Speech as Free Expression* 157 \(2021\).
