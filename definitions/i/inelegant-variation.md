...
Variety for variety's sake in word choice can confuse readers. If you call a car "the BMW" in one place and "the sporty import" in another, can your reader be certain that you're referring to the same car? If you write about a person's "candor" in one sentence and "honesty" in the next, is the reader to infer that you are distinguishing between two traits, or just using different words to refer to the same one?

The more formal the writing, the worse this fault can be. It is a maxim in interpreting legal language that if different words are used, different meanings must have been intended. In less formal contexts, variety is more forgivable—but there are always limits.

Perhaps the most famous example is *elongated yellow fruit* as the second reference for *banana*. Hence Charles W. Morton named "the elongated-yellow-fruit school of writing," citing examples such as these:
