...
Generally speaking, the phrases *on an ad hoc basis* and *in an ad hoc way* are verbose for the adverb *ad hoc*. \(See **basis \(a\)**.) Likewise, *ad hoc* should rarely if ever be qualified by *very* or *fairly.*
