...
The theory behind using *an* in such a context is that the *h* is weak when the accent is on the second rather than the first syllable (giving rise, by analogy, to *\*an habitual offender*, *\*an hallucinatory image*, and *\*an hysterical crowd*). Hence no authority countenances *\*an history*, though a few older ones prefer *\*an historian* and *\*an historical*.
