...
adversary, adj.; **adversarial**. *Adversary*, which can act as both noun and adjective, is traditional in phrases such as *adversary relationship* and *adversary system*—e.g.: "Granted, it is the job of an opposing political chairman working in the *adversary system* of American politics to try to make the worst case against the elected leader of the opposition party." Bill Hall, "The Premature Failure of Gary Locke's First Year," *Lewiston Morning Trib.* \(Idaho\), 26 Feb. 1997, at A10.
