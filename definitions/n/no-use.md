...
no use. Eric Partridge labeled this "incorrect—or, at best, colloquial—for *of no use*" \(*U&A* at 203\). Yet *it's no use* has greatly outranked *it's of no use* in print sources since about 1830. Although some readers and listeners would consider *no use* colloquial, the following examples certainly aren't incorrect:
 ...
 - "It is *no use* comparing this city to others, because there is no other city in the world like it." Dennis Duggan, "The Battle in Defense of Hearth and Home," *Newsday* \(N.Y.\), 8 May 1997, at A8.

 - "But it's *no use*." George Howe Colt, "The Strange Allure of Disasters," *Life*, June 1997, at 58.

 - "She knows it's *no use* forcing the feisty elders of Ferry County." Erica Curless, "‘The Fire Ain't Going to Get Us,'" *Spokesman-Rev.* \(Spokane\), 3 Sept. 2015, at A1.
