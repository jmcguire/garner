...
The term *nonword* might appear to be a nonword itself because until recently it did not appear in most dictionaries. Today that has changed, though: *W11*, for example, defines it as "a word that has no meaning, is not known to exist, or is disapproved," and dates it from 1961. The *OED* impressively traces it back to 1893. Oh, it's a word, all right.
