...
Fowler's American contemporary, John F. Genung, was more sensible in his approach (writing somewhat earlier): "Capable of being either an adjective or an adverb, \[*only*\] can modify almost any part of speech; so if not placed immediately before the word (or phrase) to which it belongs its force is liable to be stolen by what comes between." *Outlines of Rhetoric* 71 (1893).
...
**Language-Change Index:** *only* separated from the word it limits: Stage 4
...
**C. As Nongradable Adjective.** See adjectives (b).
