...
champ; **chomp**. The original term for what horses do to their bits is *champ*. *Chomp* began as an American variant but by 1990 had become standard in AmE in the phrase *chomping at the bit*. Cf. **stomping ground**.
...
**Language-Change Index:** *chomping at the bit* for *champing at the bit*: Stage 5
