...
Here is the situation today. *Clench* has become something you do alone, as by clenching your teeth or fists, or clenching a cigar between your teeth (if you really must). *Clinch* has become something that, in a physical sense, you do with another, as when two fighters clinch by holding each other's arms in a clutch. But *clinch* also has three nonphysical senses: (1) to accomplish something after a struggle \<the player clinched the match with an ace\>, (2) to finally secure an agreement after negotiations \<that bonus clinched the deal\>, (3) to cause someone to finally decide to do something the person had been considering \<our inability to reserve a court that weekend clinched our decision to quit the club\>. In senses 2 and 3, AmE also uses the similar-sounding word *cinch* (= to make certain to occur). See (b).
...
The physical uses of *clinch* occur in boxing, carpentry, and metalworking: clutching one's opponent in boxing is *clinching*, and fastening something with a screw or a rivet is likewise *clinching.* Apart from these specialized meanings, *clinch* should be reserved for nonphysical contexts.
...
**Language-Change Index:** *clinch* misused for *clench*: Stage 1
...
The word *cinch* (= \[1\] to pull \[a belt, strap, etc.\] tightly around something; or \[2\] to make \[something\] certain to happen), in sense 2, is close in meaning to *clinch* (= to get \[something\] done after serious effort). Although the AmE phrase *\*cinch the deal* has been in use since the 1940s, the much older phrase *clinch the deal* (dating from the late 1800s) is more common. Likewise, *clinch the argument* and *clinch the nomination* are the usual wordings—not *cinch*. The best advice is to stick to sense 1 of *cinch* \<cinching your belt\>.
