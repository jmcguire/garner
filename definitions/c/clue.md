...
clue; **clew**. *Clue* is the only current spelling for the sense "a hint; a bit of evidence." The spelling *clew* survives as a nautical term ("the lower corner of a sail") and in some literal and mythological references to thread and the like ("a ball of thread").
