...
In October 1991, during Justice Clarence Thomas's confirmation hearings, some senators consistently mispronounced this word as if it were *cooberate*—like *cooperate* with a /b/ instead of a /p/. The correct pronunciation is /kә-**rob**-ә-rayt/.

## C. And *collaborate*

The word *corroborate* is occasionally used where *collaborate* (= to work jointly with \[another\] in producing) belongs—e.g.: "The family *corroborated* \[read *collaborated*\] on a project to replicate a 1705 microscope." Edythe Jensen, "Family Turns Hobbies into Businesses," *Ariz. Republic/Phoenix Gaz.*, 5 Nov. 1994, Tempe §, at 1.
