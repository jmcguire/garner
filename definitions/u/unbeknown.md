...
unbeknown; **unbeknownst**. George P. Krapp suggested that both forms are humorous, colloquial, and dialectal. See *A Comprehensive Guide to Good English* 602 \(1927\). The *COD* likewise suggests that both are colloquial. Eric Partridge and John Simon have written, in conformity with the *OED*, that *unbeknown* is preferred over the dialectal *unbeknownst*.
